...
"""
This script was tested for the cityscapes and ds20k dataset. If you are on devcube ip:192.168.1.29 (and no data has been deleted), set the following paths in CONFIG class in "defs_glob.py" in order to reproduce:
...
class prepare_data(object):
  ...
  def probs_gt_save( self, probs, gt, img_path, i ):
    file_name = CONFIG.INPUT_DIR + "input_" + str(i) + ".hdf5"
