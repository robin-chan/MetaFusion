...
Label = namedtuple('Label',['name','Id','trainId','category','catId','color'])
...
cs_trainId2Id = {label.trainId : label for label in cs_labels}
cs_name2trainId = {label.name : label for label in cs_labels}
cs_cat2trainId = {}
for label in cs_labels:
    category = label.category
    if category in cs_cat2trainId:
        cs_cat2trainId[category].append(label.trainId)
    else:
        cs_cat2trainId[category] = [label.trainId]
